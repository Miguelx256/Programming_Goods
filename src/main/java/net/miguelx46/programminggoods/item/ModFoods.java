...
public class ModFoods {
    ...
    public static final FoodProperties JAVA_APPLE = new FoodProperties.Builder().nutrition(8)
            ...
            .effect(() -> new MobEffectInstance(MobEffects.DAMAGE_RESISTANCE, 4300, 2), 10f)
            .effect(() -> new MobEffectInstance(MobEffects.ABSORPTION, 4300, 12), 10f)
            .build();

    public static final FoodProperties JAVA_ARRAYLIST = new FoodProperties.Builder()
            .alwaysEat()
            .nutrition(6)
            .saturationMod(0.4f)
            .effect(() -> new MobEffectInstance(MobEffects.HEALTH_BOOST, 5500, 4), 10f)
            .build();
