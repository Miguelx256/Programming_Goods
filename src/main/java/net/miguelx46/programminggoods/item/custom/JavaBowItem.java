package net.miguelx46.programminggoods.item.custom;
...
public class JavaBowItem extends BowItem {

    public JavaBowItem(Item.Properties properties) {
        super(properties);
    }
    ...
    public void releaseUsing(ItemStack pStack, Level pLevel, LivingEntity pEntityLiving, int pTimeLeft) {
        if (pEntityLiving instanceof Player player) {
            ...
            int i = (int)((this.getUseDuration(pStack) - pTimeLeft) * 1.40F);
                ...
                if (!((double)f < 0.1D)) {
                    ...
                    if (!pLevel.isClientSide) {
                        ...
                        abstractarrow.setBaseDamage(
                                abstractarrow.getBaseDamage() * 1.25D
                        );
