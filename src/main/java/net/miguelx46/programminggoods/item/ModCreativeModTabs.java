    ...
    public static final RegistryObject<CreativeModeTab> PROGRAMMINGGOODS_TAB = CREATIVE_MODE_TAB.register("programminggoods_tab",
            () -> CreativeModeTab.builder().icon(() -> new ItemStack(ModItems.JAVA_COFFEE.get()))
                    ...
                    .displayItems((pParameters, pOutput) -> {
                        ...
                        pOutput.accept(ModItems.JAVA_CREEPER_SPAWN_EGG.get());
                        pOutput.accept(ModItems.JAVA_SPIDER_SPAWN_EGG.get());
                        ...
                        pOutput.accept((ModItems.JAVA_BOW.get()));
                        ...
                        pOutput.accept(ModItems.JAVA_STICK.get());
                        pOutput.accept(ModItems.JAVA_STRING.get());

                        pOutput.accept(ModBlocks.JAVA_COMPILER_TABLE.get());

                        pOutput.accept(ModBlocks.JAVA_HYPER_STONE.get());
                        pOutput.accept(ModBlocks.JAVA_TNT.get());
